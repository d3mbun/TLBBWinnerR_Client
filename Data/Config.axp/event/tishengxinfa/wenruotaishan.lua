...
x890004_g_IsMissionOkFail	= 0		--ÈÎÎñ²ÎÊýµÄµÚ0Î»
...
x890004_g_StrList = {
"ÐÕi Quang Minh Kinh",
"Thiên Ð¸a Na Di Pháp",
"Hàng Long Th§p Bát Chß·ng Thßþng Quy¬n",
"Hß Thñc Quyªt",
"T¦y Tüy Kinh",
"Tam Tiªu Tiêu Dao Tán",
"ÐÕo Dçn Thu§t",
"Quy TÑc Công",
"Thái Bình Yªu Thu§t",
...
"Viêm Dß½ng Tâm Pháp",                         --newmenpai
"Mµ Dung Th¡ng#{_INFOAIM69,125,284,Mµ Dung Th¡ng}",
}
...
x890004_g_Custom	= { {id="Ðã luy®n ðªn c¤p 35",num=1} }
